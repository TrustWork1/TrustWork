...
const serviceList = [
  {
    ...
    description: 'A routine examination to assess overall health and detect any potential issues early.'
  },
  {
    id: 2,
    name: 'Pediatric Care',
    description: 'Medical services focused on the health and development of infants, children, and adolescents.'
  },
  {
    id: 3,
    name: 'Cardiology Consultation',
    description:
      'Specialized care for heart-related conditions, including diagnosis and management of cardiovascular diseases.'
  },
  {
    id: 4,
    name: 'Orthopedic Surgery',
    description:
      'Surgical procedures to treat musculoskeletal issues such as fractures, joint disorders, and spinal conditions.'
  },
  {
    id: 5,
    name: 'Dermatology Services',
    description: 'Diagnosis and treatment of skin conditions, including acne, eczema, and skin cancers.'
  },
  {
    id: 6,
    name: 'Gynecology',
    description:
      "Medical care focusing on women's reproductive health, including routine exams, screenings, and treatment of gynecological conditions."
  },
  {
    id: 7,
    name: 'Emergency Care',
    description:
      'Immediate treatment for urgent and life-threatening conditions, including trauma and acute medical crises.'
  },
  {
    id: 8,
    name: 'Oncology',
    description: 'Specialized care for cancer patients, including diagnosis, treatment options, and supportive care.'
  },
  {
    id: 9,
    name: 'Endocrinology',
    description: 'Medical care focusing on hormonal and metabolic disorders, such as diabetes and thyroid diseases.'
  },
  {
    id: 10,
    name: 'Physical Therapy',
    description:
      'Rehabilitative services designed to improve physical function and mobility following injury, surgery, or chronic conditions.'
  }
]
...
mock.onGet('/apps/services/list').reply(config => {
  ...
  const filteredData = serviceList.filter(
    service =>
      service.name.toLowerCase().includes(queryLowered) || service.description.toLowerCase().includes(queryLowered)
  )
