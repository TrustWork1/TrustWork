...
import AddEditDrawer from 'src/views/apps/landing-page-cms/about/why-trust-us/list/AddEditDrawer'
...
const AddPointsList = () => {
  ...
  const { data } = useQuery({
    queryKey: [listOfUniqueKeys.aboutUs.whyTrustUs.list],
    queryFn: fetchWhyTrustUsPointsList
  })
  ...
  return (
    <Grid container spacing={6.5}>
      <Grid item xs={12}>
        ...
        <Card>
          <CardHeader title='List of Points' className='secondaryDesign' />
