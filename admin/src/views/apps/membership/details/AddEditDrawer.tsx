        ...
        <form onSubmit={e => e.preventDefault()}>
          <Grid container>
            ...
            <Grid item md={6} sx={{ px: 2, mb: 3 }}>
              ...
              <Typography variant='body2'>{`$ ${data?.project_total_cost ?? 0}`}</Typography>
            </Grid>
            <Grid item md={6} sx={{ px: 2, mb: 3 }}>
              <Typography>
                <strong>Timeline:</strong>
              </Typography>
              <Typography variant='body2'>{data?.time_line || 'NA'}</Typography>
            </Grid>
            ...
            <Grid item md={12} sx={{ px: 2, mb: 3 }}>
              ...
              <Typography variant='body2'>{data?.status || 'NA'}</Typography>
            </Grid>
          </Grid>
        </form>
      </Box>
