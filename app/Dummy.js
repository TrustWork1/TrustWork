...
import {height, width} from '../../themes/css';
      ...
      <TouchableOpacity
        ...
        <View
          ...
          {item?.feedback?.length > 0 ? (
            ...
            <Text style={styles.featuredStarRatingTxt}>{'0/5'}</Text>
          )}
        </View>
      </TouchableOpacity>
    );
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <Modal
        ...
        onBackButtonPress={() => setshowServiceModal(false)}
        onBackdropPress={() => setshowServiceModal(false)}>
        {serviceComponent()}
      </Modal>
    </View>
  );
