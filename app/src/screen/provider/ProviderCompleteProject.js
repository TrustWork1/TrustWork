...
const ProviderCompleteProject = props => {
  ...
  const projectCompletedRender = (item, index) => {
    return (
      <>
        <StatusCard
    ...
    <View style={styles.mainContainer}>
      <SafeAreaView style={styles.mainContainer}>
        <View style={styles.container}>
          ...
          <FlatList
            data={projectList}
            renderItem={({item, index}) => projectCompletedRender(item, index)}
...
export default ProviderCompleteProject;
