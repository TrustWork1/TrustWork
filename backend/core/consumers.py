...
class ChatConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        try:
            ...
            print(f"✅ WebSocket connected to room: {self.room}")
    ...
    async def disconnect(self, close_code):
        try:
            ...
            print(f"ℹ️ WebSocket disconnected from room {self.room_group_name}")
        except Exception as e:
    ...
    def save_message(self, username, message, stream_name):
        ...
        try:
            ...
            print(f"❌ Error while saving message to DB: {e}")
            return None
