    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password_reset_otp', models.CharField(blank=True, max_length=4, null=True)),
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('client', 'Client'), ('provider', 'Service Provider')], max_length=20)),
