...
from escrow_management.views.initiate_disbursement import (
    DisbursementTransactionStatusAPI,
    InitiateDisbursementAPI,
    MtnAccountAddStatusAPI,
)
...
urlpatterns = [
    ...
    path('preapproval-status/<str:reference_id>', MtnSubscriptionPreapprovalStatus.as_view()),
    path('preapproval-status/<str:reference_id>/', MtnSubscriptionPreapprovalStatus.as_view()),
